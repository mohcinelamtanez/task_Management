...
export class ProjetListAdminComponent implements OnInit {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProjetDto>();
    ...
    public async edit(dto: ProjetDto) {
    ...
    public async view(dto: ProjetDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProjetDto) {
    ...
    public async duplicate(dto: ProjetDto) {
    ...
    public exportPdf(dto: ProjetDto): void {
...
// add
	...
	public initDuplicate(res: ProjetDto) {
        if (res.nros != null) {
             res.nros.forEach(d => { d.projet = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<ProjetDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProjetDto>) {
