...
@Component({
  selector: 'app-nro-list-admin',
  templateUrl: './nro-list-admin.component.html'
})
export class NroListAdminComponent implements OnInit {

    protected fileName = 'Nro';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<NroDto>();
    ...
    public async delete(dto: NroDto) {
    ...
    public async duplicate(dto: NroDto) {
    ...
    public exportPdf(dto: NroDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'projet?.libelle', header: 'Projet'},
        ];
    }


    public async loadProjet(){
        this.projetService.findAllOptimized().subscribe(projets => this.projets = projets, error => console.log(error))
    }


	public initDuplicate(res: NroDto) {
        if (res.sros != null) {
             res.sros.forEach(d => { d.nro = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Projet': this.criteria.projet?.libelle ? this.criteria.projet?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<NroDto> {
        return this.service.selections;
    }

    set selections(value: Array<NroDto>) {
