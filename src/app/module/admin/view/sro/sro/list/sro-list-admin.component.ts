...
@Component({
  selector: 'app-sro-list-admin',
  templateUrl: './sro-list-admin.component.html'
})
export class SroListAdminComponent implements OnInit {

    protected fileName = 'Sro';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SroDto>();
    ...
    public async delete(dto: SroDto) {
    ...
    public async duplicate(dto: SroDto) {
    ...
    public exportPdf(dto: SroDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'nro?.libelle', header: 'Nro'},
        ];
    }


    public async loadNro(){
        this.nroService.findAllOptimized().subscribe(nros => this.nros = nros, error => console.log(error))
    }


	public initDuplicate(res: SroDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        //'Nro': this.criteria.nro?.libelle ? this.criteria.nro?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<SroDto> {
        return this.service.selections;
    }

    set selections(value: Array<SroDto>) {
