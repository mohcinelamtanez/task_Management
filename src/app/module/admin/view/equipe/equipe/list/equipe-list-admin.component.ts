...
@Component({
  selector: 'app-equipe-list-admin',
  templateUrl: './equipe-list-admin.component.html'
})
export class EquipeListAdminComponent implements OnInit {

    protected fileName = 'Equipe';
    ...
    chefEquipes: Array<CollaboratorDto>;
    typeEquipes: Array<TypeEquipeDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EquipeDto>();
    ...
    public async edit(dto: EquipeDto) {
    ...
    public async view(dto: EquipeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EquipeDto) {
    ...
    public async duplicate(dto: EquipeDto) {
    ...
    public exportPdf(dto: EquipeDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'chefEquipe?.description', header: 'Chef equipe'},
            {field: 'typeEquipe?.libelle', header: 'Type equipe'},
        ];
    }


    public async loadChefEquipe(){
        this.collaboratorService.findAllOptimized().subscribe(chefEquipes => this.chefEquipes = chefEquipes, error => console.log(error))
    }
    public async loadTypeEquipe(){
        this.typeEquipeService.findAllOptimized().subscribe(typeEquipes => this.typeEquipes = typeEquipes, error => console.log(error))
    }


	public initDuplicate(res: EquipeDto) {
        if (res.membreEquipes != null) {
             res.membreEquipes.forEach(d => { d.equipe = null; d.id = null; });
        }
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Code': e.code ,
                 'Libelle': e.libelle ,
                'Chef equipe': e.chefEquipe?.description ,
                'Type equipe': e.typeEquipe?.libelle ,
            }
        });
        ...
        //'Chef equipe': this.criteria.chefEquipe?.description ? this.criteria.chefEquipe?.description : environment.emptyForExport ,
        //'Type equipe': this.criteria.typeEquipe?.libelle ? this.criteria.typeEquipe?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<EquipeDto> {
        return this.service.selections;
    }

    set selections(value: Array<EquipeDto>) {
