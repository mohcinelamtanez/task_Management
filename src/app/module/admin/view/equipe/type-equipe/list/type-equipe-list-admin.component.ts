...
@Component({
  selector: 'app-type-equipe-list-admin',
  templateUrl: './type-equipe-list-admin.component.html'
})
export class TypeEquipeListAdminComponent implements OnInit {

    protected fileName = 'TypeEquipe';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypeEquipeDto>();
    ...
    public async edit(dto: TypeEquipeDto) {
    ...
    public async view(dto: TypeEquipeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypeEquipeDto) {
    ...
    public async duplicate(dto: TypeEquipeDto) {
    ...
    public exportPdf(dto: TypeEquipeDto): void {
...
// add
	...
	public initDuplicate(res: TypeEquipeDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<TypeEquipeDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypeEquipeDto>) {
