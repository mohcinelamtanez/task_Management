...
@Component({
  selector: 'app-type-equipe-view-admin',
  templateUrl: './type-equipe-view-admin.component.html'
})
export class TypeEquipeViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeEquipeAdminService){
