...
@Component({
  selector: 'app-membre-equipe-list-admin',
  templateUrl: './membre-equipe-list-admin.component.html'
})
export class MembreEquipeListAdminComponent implements OnInit {

    protected fileName = 'MembreEquipe';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MembreEquipeDto>();
    ...
    public async edit(dto: MembreEquipeDto) {
    ...
    public async view(dto: MembreEquipeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MembreEquipeDto) {
    ...
    public async duplicate(dto: MembreEquipeDto) {
    ...
    public exportPdf(dto: MembreEquipeDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'equipe?.libelle', header: 'Equipe'},
            {field: 'grad?.libelle', header: 'Grad'},
            {field: 'collaborator?.description', header: 'Collaborator'},
        ];
    }


    public async loadEquipe(){
        this.equipeService.findAllOptimized().subscribe(equipes => this.equipes = equipes, error => console.log(error))
    }
    public async loadGrad(){
        this.gradService.findAllOptimized().subscribe(grads => this.grads = grads, error => console.log(error))
    }
	...
	public initDuplicate(res: MembreEquipeDto) {
	}
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
        //'Equipe': this.criteria.equipe?.libelle ? this.criteria.equipe?.libelle : environment.emptyForExport ,
        //'Grad': this.criteria.grad?.libelle ? this.criteria.grad?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<MembreEquipeDto> {
        return this.service.selections;
    }

    set selections(value: Array<MembreEquipeDto>) {
